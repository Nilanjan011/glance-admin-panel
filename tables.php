			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Student Table</h4>
						<a href="forms.php"><button class="btn btn-primary">Add</button></a>
						<br><br>
		                    ...
		                    ?>
						 	<tr> 
			                    ...
			                    <td><?= $row['location'] ?></td>
					 		    ...
					 		    <td><?= $row['details'] ?></td>
			                    <td><?= $row['price'] ?></td>
			                    <td> <a href="student.php?case=edit&id=<?php echo $row['id'];?>" name="edit" class="btn btn-outline-primary" >Update</a> </td>
			                    <td><form action="student.php?case=delete" onclick="return confirm('Do you want to delete')" method="post">
